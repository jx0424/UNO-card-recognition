...
# # cv2.imshow('colour' ,img_colour)
    ...
    for i, c in enumerate(contours):         # loop through all the found contours
        ...
        cv2.putText(img_colour, str(i), (c[0, 0, 0]+20, c[0, 0, 1]+30), cv2.FONT_HERSHEY_DUPLEX, 1, (0, 0, 255))    # identify contour c#     [x,y,w,h] = cv2.boundingRect(c)
...
print(data_X)
    ##To display the contours for checking     
